...
/**
 * Luokka perii Kuvio-luokan ja määrittelee tarkemmin minkälainen on
 * Palkki-kuvio. Palkki koostuu neljästä "palkin" muotoon asetellusta palasta
 * (ts. joko y- koordinaatti tai x-koordinaatti on palkin paloilla sama,
 * riippuen palkin asennosta). Konstruktorin parametrit määrittävät
 * rotaatiopisteenä olevan palan sijainnin.
 *
 * @author Johannes
 */
public class Palkki extends Kuvio {
    ...
    /**
     * Metodi kertoo onko palkki vaaka-asennossa palauttamalla tätä tilannetta
     * vastaavan totuusarvon.
     *
    ...
    /**
     * Metodi kääntää palan vaaka-asennosta pystyasentoon. Kääntäminen tapahtuu
     * myötäpäivään ja kääntökulma on 90 astetta.
     *
    ...
    /**
     * Metodi kääntää palan pystyasennosta vaaka-asentoon. Kääntäminen tapahtuu
     * myötäpäivään ja kääntökulma on 90 astetta.
     *
     * @see tetris.domain.Palkki#getRotaatioPisteenaOlevaPala()
     *
